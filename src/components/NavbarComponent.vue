...
<nav class="bg-white">
  <div class="w-full flex flex-wrap items-center justify-end mx-auto p-4 shadow">
  <div class="flex items-center md:order-2 mr-8">
      <button type="button" class="flex mr-3 text-sm border-2 border-black rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
