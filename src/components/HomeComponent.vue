    ...
    <div class="flex flex-wrap space-x-40 justify-center">
        ...
        <RouterLink to="/addcliente">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-36 h-36 text-black">
                    ...
                    <p class="text-orange-400 font-semibold mt-8 mb-2">Novo Cliente</p>
                </a>
            </div>
        </RouterLink>
        <RouterLink to="/clientes">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-36 h-36 text-black">
                    ...
                    <p class="text-orange-400 font-semibold mt-8 mb-2">Clientes</p>
                </a>
            </div>
        </RouterLink>
    </div> 
    <div class="flex flex-wrap space-x-40 justify-center">
        <RouterLink to="/estoque">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-36 h-36 text-black">
                    ...
                    <p class="text-orange-400 font-semibold mt-8 mb-2">Estoque</p>
                </a>
            </div>
        </RouterLink>
        <RouterLink to="/pedidos">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-36 h-36 text-black">
                    ...
                    <p class="text-orange-400 font-semibold mt-8 mb-2">Pedidos</p>
                </a>
            </div>
        </RouterLink>
        <RouterLink to="/financeiro">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-36 h-36 text-black">
                    ...
                    <p class="text-orange-400 font-semibold mt-8 mb-2">Financeiro</p>
                </a>
            </div>
        </RouterLink>
    </div>
